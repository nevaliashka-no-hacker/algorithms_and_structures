...
def count_above_average(head) -> int:
    '''Подсчитать, сколько элементов списка строго больше
       ...
       2 длина, сумма, результат, ср арифм
       3 проходимся по всему и отдельно по последнему,
         считаем длину и сумму
       4 находим ср арифм
       5 проходимся по всему и отдельно по последнему,
         считаем подходящие элементы'''
    ...
    print(len_head, sum_head, arith_mean)
